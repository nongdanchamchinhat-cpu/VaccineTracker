  ...
  return (
    <div className="min-h-screen px-4 py-6 md:px-8">
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="overflow-hidden rounded-[28px] bg-ink text-white shadow-soft">
            ...
            <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-soft">
              ...
              {memberSettingsOpen && selectedMember && (
                <div className="mt-6 rounded-[20px] border border-slate-200 bg-slate-50 p-5">
                  ...
                  <div className="mt-4 flex flex-col gap-3 rounded-[18px] border border-rose-200 bg-rose-50/80 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-5">
                    <div>
                      <p className="text-xs font-bold text-rose-900">Xóa hồ sơ này</p>
                      <p className="text-[11px] leading-5 text-rose-600">
                        Xóa vĩnh viễn khỏi trình duyệt này. Hành động không thể hoàn tác.
                      </p>
                    </div>
                    <button
                      onClick={() => handleDeleteMember(selectedMember.id)}
                      className="rounded-xl border border-rose-200 bg-white px-4 py-2 text-sm font-bold text-rose-700 transition hover:bg-rose-100"
                    >
                      Xóa hồ sơ
                    </button>
                  </div>
            ...
            {selectedMember ? (
              <>
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  {/* Tiến độ */}
                  <div className="min-h-[146px] rounded-[24px] border border-slate-200 bg-white p-4 shadow-soft sm:min-h-[158px] sm:p-5">
                    <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-slate-400 sm:tracking-wider">
                      Tiến độ
                    </p>
                    <div className="mt-3 text-[clamp(2rem,7vw,2.4rem)] font-black leading-none text-ink">
                      {progress}%
                    </div>
                  ...
                  <div className="min-h-[146px] rounded-[24px] border border-slate-200 bg-white p-4 shadow-soft sm:min-h-[158px] sm:p-5">
                    ...
                    <div className="mt-3 text-[clamp(2rem,7vw,2.4rem)] font-black leading-none text-amber-600">
                      {todoItems.length}
                    </div>
                    <p className="mt-2 text-sm text-slate-500">
                      Cần hoàn thành.
                  ...
                  <div className="min-h-[146px] rounded-[24px] border border-slate-200 bg-white p-4 shadow-soft sm:min-h-[158px] sm:p-5">
                    ...
                    <div
                      className="mt-3 text-[clamp(1.65rem,6vw,2rem)] font-black leading-tight text-teal-700"
                  ...
                  <div className="min-h-[146px] rounded-[24px] border border-slate-200 bg-white p-4 shadow-soft sm:min-h-[158px] sm:p-5">
                    ...
                    <div
                      className="mt-3 text-[clamp(1.65rem,6vw,2rem)] font-black leading-tight text-ink"
                ...
                <div className="rounded-[24px] border border-amber-200 bg-amber-50/70 p-4 shadow-soft sm:p-5">
                  <p className="text-sm font-bold text-amber-950">Lưu ý y khoa</p>
                  <p className="mt-2 text-sm leading-6 text-amber-900">
                    Lịch mẫu chỉ để tham khảo. Mọi quyết định tiêm, dời lịch hoặc bỏ mũi cần được
                    bác sĩ hoặc cơ sở tiêm chủng xác nhận.
                  </p>
                </div>
