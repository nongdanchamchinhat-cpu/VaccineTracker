...
insert into public.vaccine_templates (
  ...
  ('vn_default_v1', 5, 'Mốc 2 tháng tuổi', 87, '2 tháng 27 ngày', 'Vaxigrip Tetra (Cúm) — Mũi 1', 'Pháp', 'Cúm mùa', 385000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 6, 'Mốc 4 tháng tuổi', 115, '3 tháng 25 ngày', 'Infanrix Hexa (6 trong 1) — Mũi 2', 'Bỉ', 'Bạch hầu, Ho gà, Uốn ván, Bại liệt, Viêm gan B, Hib', 1098000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 7, 'Mốc 4 tháng tuổi', 122, '4 tháng 2 ngày', 'Rotateq — Liều uống 2', 'Mỹ', 'Tiêu chảy cấp do Rotavirus', 665000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 8, 'Mốc 4 tháng tuổi', 129, '4 tháng 9 ngày', 'Prevenar 13 (Phế cầu) — Mũi 2', 'Bỉ', 'Viêm phổi, Viêm màng não, Viêm tai giữa do phế cầu', 1190000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 9, 'Mốc 4 tháng tuổi', 136, '4 tháng 16 ngày', 'Bexsero (Não mô cầu B) — Mũi 2', 'Ý', 'Viêm màng não do não mô cầu nhóm B', 1788000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 10, 'Mốc 4 tháng tuổi', 143, '4 tháng 23 ngày', 'Vaxigrip Tetra (Cúm) — Mũi 2', 'Pháp', 'Cúm mùa (nhắc lại)', 385000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 11, 'Mốc 6 tháng tuổi', 178, '5 tháng 27 ngày', 'Infanrix Hexa (6 trong 1) — Mũi 3', 'Bỉ', 'Bạch hầu, Ho gà, Uốn ván, Bại liệt, Viêm gan B, Hib', 1098000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 12, 'Mốc 6 tháng tuổi', 185, '6 tháng 4 ngày', 'Rotateq — Liều uống 3', 'Mỹ', 'Tiêu chảy cấp do Rotavirus', 665000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 13, 'Mốc 6 tháng tuổi', 192, '6 tháng 11 ngày', 'Prevenar 13 (Phế cầu) — Mũi 3', 'Bỉ', 'Viêm phổi, Viêm màng não, Viêm tai giữa do phế cầu', 1190000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 14, 'Mốc 6 tháng tuổi', 206, '6 tháng 25 ngày', 'Menactra (Não mô cầu ACYW) — Mũi 1', 'Mỹ', 'Viêm màng não do não mô cầu A, C, Y, W', 1350000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 15, 'Mốc 9 tháng tuổi', 269, '8 tháng 26 ngày', 'MVVAC (Sởi đơn)', 'Việt Nam', 'Sởi', 250000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 16, 'Mốc 9 tháng tuổi', 276, '9 tháng 3 ngày', 'Menactra (Não mô cầu ACYW) — Mũi 2', 'Mỹ', 'Viêm màng não do não mô cầu A, C, Y, W', 1350000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 17, 'Mốc 9 tháng tuổi', 283, '9 tháng 10 ngày', 'Jevax (Viêm não Nhật Bản) — Mũi 1', 'Việt Nam', 'Viêm não Nhật Bản', 155000, '08:00:00', 'vn_default_v1'),
  ...
  ('vn_default_v1', 21, 'Mốc 12 tháng tuổi', 388, '12 tháng 28 ngày', 'Prevenar 13 (Phế cầu) — Mũi nhắc', 'Bỉ', 'Phế cầu (nhắc lại)', 1190000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 22, 'Mốc 12 tháng tuổi', 395, '13 tháng 5 ngày', 'Bexsero (Não mô cầu B) — Mũi nhắc', 'Ý', 'Não mô cầu B (nhắc lại)', 1788000, '08:00:00', 'vn_default_v1'),
  ('vn_default_v1', 23, 'Mốc 12 tháng tuổi', 402, '13 tháng 12 ngày', 'MenQuadfi — Mũi nhắc', 'Pháp', 'Não mô cầu ACYW', 1350000, '08:00:00', 'vn_default_v1')
